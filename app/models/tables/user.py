...
class User(Base):
    ...
    user_type: Mapped[UUID] = mapped_column(String(36), ForeignKey('user_type.id'), unique=False, nullable=False)

    def __init__(self, name: str, email:str, password_hash: str, user_type: UUID):
        self.name = name
        self.email = email
